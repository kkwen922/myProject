...
public interface OmsOrganizationService extends IService<OmsOrganization> {
     ...
     * @return
     */
    Page<OmsOrganization> list(Long companyId, Long parentId, Integer pageSize, Integer pageNum);
     ...
     * @return
     */
    Page<OmsOrganization> listLevel(Long companyId, Integer pageSize, Integer pageNum);
     ...
     * @return
     */
    Page<OmsOrganization> listCombox(Long comapnyId, Integer pageSize, Integer pageNum);
     ...
     * @return
     */
    List<OmsOrganization> listOrgByComapnyId(Long companyId);
