package my.project.modules.dms.controller;
...
import my.project.modules.dms.dto.DeviceMap;
...
import my.project.modules.dms.service.DmsDeviceCategoryService;
import my.project.modules.dms.service.DmsDeviceService;
...
public class DmsDeviceController {
    ...
    @ResponseBody
    public CommonResult<CommonPage<DmsDevice>> listCompanyPage(
        ...
        Page<DmsDevice> deviceList = deviceService.list(companyId, null, pageSize, pageNum);
    ...
    public CommonResult<DmsDevice> register(
        ...
        dmsDeviceParam.setCompanyId(companyId);
