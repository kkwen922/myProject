package my.project.modules.dms.service.impl;
...
import my.project.modules.dms.mapper.DmsDeviceMapper;
...
public class DmsDeviceServiceImpl extends ServiceImpl<DmsDeviceMapper, DmsDevice> implements DmsDeviceService {
    ...
    @Override
    public Page<DmsDevice> list(Long companyId, String keyword, Integer pageSize, Integer pageNum) {

        log.debug("Keyword:" + keyword);
        Page<DmsDevice> page = new Page<>(pageNum, pageSize);
        if (StrUtil.isNotEmpty(keyword)) {
        } else {
            Page<DmsDevice> umsAdminList = dmsDeviceMapper.getDeviceListByCompanyId(page, companyId);
        }
        return page;
