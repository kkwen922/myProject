...
import my.project.common.exception.Asserts;
...
public class UmsAdminServiceImpl extends ServiceImpl<UmsAdminMapper, UmsAdmin> implements UmsAdminService {
    ...
    @Override
    public Page<UmsAdmin> list(Long companyId, String keyword, Integer pageSize, Integer pageNum) {

        log.debug("Keyword:" + keyword);
        Page<UmsAdmin> page = new Page<>(pageNum, pageSize);
        if (StrUtil.isNotEmpty(keyword)) {
            Page<UmsAdmin> umsAdminList = umsAdminMapper.getAdminByUsernameAndCompanyId(page, keyword, companyId);
        } else {
            Page<UmsAdmin> umsAdminList = umsAdminMapper.getAdminByCompanyId(page, companyId);
        }
        return page;
...
//
//    @Override
//    public AdminUserDetails loadUserByUsernameAndInvoice(String username,Long invoiceNumber){
//
//        UmsAdmin admin = getAdminByUsername(username);
//        if(admin != null){
//            List<UmsResource> resourceList = getResourceList(admin.getId());
